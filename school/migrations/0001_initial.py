# Generated by Django 3.2.3 on 2021-07-05 17:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='SchoolAdmin',
            fields=[
                ('schooladminid', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='school.customuser')),
                ('city', models.CharField(max_length=20)),
                ('phone', models.IntegerField()),
                ('address', models.TextField(max_length=40)),
                ('gender', models.CharField(max_length=6)),
                ('experience', models.CharField(max_length=30)),
                ('photo', models.ImageField(null=True, upload_to='dumyschool/schooladminpic')),
            ],
        ),
        migrations.CreateModel(
            name='Trainee',
            fields=[
                ('trainee_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='school.customuser')),
                ('City', models.CharField(max_length=100)),
                ('Address', models.TextField()),
                ('Phone', models.CharField(max_length=10)),
                ('Gender', models.CharField(max_length=6)),
                ('DateOfAdmission', models.DateField()),
                ('Photo', models.FileField(default='', upload_to='school/traineepic')),
        ...
        migrations.CreateModel(
            name='Trainer',
            fields=[
                ('trainer_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='school.customuser')),
                ('phone', models.CharField(max_length=10)),
                ...
                ('photo', models.FileField(null=True, upload_to='dumyschool/trainerpic')),
            ],
        ),
    ]
