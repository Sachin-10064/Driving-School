...
class SchoolAdmin(models.Model):
    ...
    photo = models.ImageField(upload_to="dumyschool/schooladminpic",max_length=100, null=True)
...
class Trainer(models.Model):
    ...
    photo = models.FileField(max_length=100,upload_to="dumyschool/trainerpic",null=True)

class Trainee(models.Model):
    trainee_id = models.OneToOneField(CustomUser, on_delete=models.CASCADE, primary_key=True)
...
class Tips(models.Model):
    ...
    tipstitle = models.CharField(max_length=100, null=False)
    tips_dis = models.TextField(null=False,default="")
